package com.johnson.router.compiler.utils;
...
public interface Constants {
    ...
    String ANNO_FACADE_PKG = "com.johnson.router.facade";
    ...
    String ISYRINGE = "com.johnson.component.componentlib.router.ISyringe";

    String JSON_SERVICE = "com.johnson.component.componentlib.service.JsonService";

    String BASECOMPROUTER = "com.johnson.component.componentlib.router.ui.BaseCompRouter";
